...
Uses the **official** [`nextcloud`](https://hub.docker.com/_/nextcloud) image, Collabora’s official [`collabora/code`](https://hub.docker.com/r/collabora/code) image, and **official** [`mariadb:11.8`](https://hub.docker.com/_/mariadb) (not SQLite). Nextcloud 34 recommends MariaDB 10.6–11.8; Docker’s `mariadb:lts` currently tracks 12.x and trips the admin overview warning.
...
- Image: `mariadb:11.8` (Nextcloud 34 supported range; not `mariadb:lts` / 12.x)
